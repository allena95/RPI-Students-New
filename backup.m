...
xlabel('SOC code')
ylabel('Performance')
title('SOC Code vs. Performance (Cumulative GPA Fall 2014 > 2.67)')

subplot(2,2,2)
line(blah2(:,1),blah2(:,2),'Color',[0.2 0.5 0.8],'linewidth',2.5)
xlabel('SOC code')
ylabel('Performance')
title('SOC Code vs. Performance (Cumulative GPA Fall 2014 > 3)')

subplot(2,2,3)
line(blah3(:,1),blah3(:,2),'Color',[0.2 0.5 0.8],'linewidth',2.5)
xlabel('SOC code')
ylabel('Performance')
title('SOC Code vs. Performance (Cumulative GPA Fall 2014 > 3.33)')

subplot(2,2,4)
line(blah4(:,1),blah4(:,2),'Color',[0.2 0.5 0.8],'linewidth',2.5)
xlabel('SOC code')
ylabel('Performance')
title('SOC Code vs. Performance (Cumulative GPA Fall 2014 > 3.67)')
